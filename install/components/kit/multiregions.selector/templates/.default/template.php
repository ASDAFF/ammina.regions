...
<div class="bam-multiregions-confirm">
	...
	if ($arResult['CONFIRM_REQUEST_SHOW']) {
		...
		<div class="bam-multiregions-confirm-content">
			<div class="bam-multiregions-confirm-content-arrow"></div>
			...
			<div class="bam-multiregions-confirm-buttons">
				<a href="javascript:void(0)"
				   class="bam-multiregions-confirm-button bam-multiregions-confirm-button-no"><?= Loc::getMessage("KIT_COMPONENT_MULTIREGIONS_NO") ?></a><a
