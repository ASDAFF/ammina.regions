 ...
 * Обновление вносит значительные изменения в структуру таблиц базы данных. Обязательно перед обновлением модуля создайте резервную копию сайта (либо дамп таблиц модуля am_regions_* и архив файлов модуля /bitrix/modules/ammina.regions/)<br><br>
