		...
		$result = '
			<table border="0" cellspacing="0" cellpadding="0" width="100%" class="adm-detail-content-table edit-table">
				<tbody>
					...
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_DESCRIPTION") . ':</td>
						<td class="adm-detail-content-cell-r">
					...
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_IS_SYSTEM") . ':</td>
