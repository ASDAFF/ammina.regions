...
class Price
{
	public static function getEdit($arItem)
	{
		...
		if (\CModule::IncludeModule("currency")) {
			$strSelectCurrency = '<option value="">' . Loc::getMessage("AMMINA_REGIONS_FIELD_CURRENCY_NOT_CHANGE") . '</option>';
		...
		$result = '
			<table border="0" cellspacing="0" cellpadding="0" width="100%" class="adm-detail-content-table edit-table">
				<tbody>
					...
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_SORT") . ':</td>
						<td class="adm-detail-content-cell-r">
							<input type="text" class="adm-bus-input" name="FIELDS[SORT]" maxlength="255" id="FIELD_SORT" value="' . htmlspecialcharsbx($arItem['SORT']) . '" />
						</td>
					</tr>
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_CURRENCY") . ':</td>
						<td class="adm-detail-content-cell-r">
							<select class="adm-bus-select" name="FIELDS[CURRENCY]" id="FIELD_CURRENCY">' . $strSelectCurrency . '</select>
						</td>
					</tr>
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_PRICE_FROM_ID") . ':</td>
						<td class="adm-detail-content-cell-r">
							<select class="adm-bus-select" name="FIELDS[PRICE_FROM_ID]" id="FIELD_PRICE_FROM_ID">' . $strSelectPriceFrom . '</select>
						</td>
					</tr>
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_PRICE_TO_ID") . ':</td>
						<td class="adm-detail-content-cell-r">
							<select class="adm-bus-select" name="FIELDS[PRICE_TO_ID]" id="FIELD_PRICE_TO_ID">' . $strSelectPriceTo . '</select>
						</td>
					</tr>
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_PRICE_CHANGE") . ':</td>
						<td class="adm-detail-content-cell-r">
							<select class="adm-bus-select" name="FIELDS[PRICE_CHANGE]" id="FIELD_PRICE_CHANGE">' . $strSelectPriceChange . '</select>
						</td>
					</tr>
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_PRICE_CHANGE_VALUE") . ':</td>
						<td class="adm-detail-content-cell-r">
