...
class Domain
{
	...
	public static function getEdit($arItem)
	{
		...
		if (\CAmminaRegions::isIMExists()) {
			$strSelectCompany = '<option value="">' . Loc::getMessage("AMMINA_REGIONS_FIELD_SALE_COMPANY_ID_SELECT") . '</option>';
		...
		foreach ($arExternalLang as $k => $v) {
			$strNameLangEdit .= '<tr><td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_NAME") . " (" . htmlspecialchars($v) . '):</td><td class="adm-detail-content-cell-r"><input type="text" class="adm-bus-input" name="FIELDS[NAME_LANG][' . $k . ']" maxlength="255" id="FIELD_NAME_LANG_' . $k . '" value="' . htmlspecialcharsbx($arItem['NAME_LANG'][$k]) . '" /></td></tr>';
		}
		$result = '
			<table border="0" cellspacing="0" cellpadding="0" width="100%" class="adm-detail-content-table edit-table">
				<tbody>
					...
					<tr>
						<td class="adm-detail-content-cell-l" style="width:40%;">' . Loc::getMessage("AMMINA_REGIONS_FIELD_NAME") . ':</td>
					...
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_IS_DEFAULT") . ':</td>
						<td class="adm-detail-content-cell-r">
					...
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_DOMAIN") . ':</td>
						<td class="adm-detail-content-cell-r">
					...
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_PATHCODE") . ':</td>
						<td class="adm-detail-content-cell-r">
					...
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_ORDER_PREFIX") . ':</td>
						<td class="adm-detail-content-cell-r">
					...
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_SITE_EXT") . ':</td>
						<td class="adm-detail-content-cell-r">
					...
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_NOINDEX") . ':</td>
						<td class="adm-detail-content-cell-r">
					...
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_SALE_UID") . ':</td>
						<td class="adm-detail-content-cell-r">
							' . FindUserID("FIELDS[SALE_UID]", $arItem['SALE_UID'], $user_name, 'ammina_regions_domain_edit_form') . '
						</td>
					</tr>
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_SALE_COMPANY_ID") . ':</td>
						<td class="adm-detail-content-cell-r">
							<select class="adm-bus-select" name="FIELDS[SALE_COMPANY_ID]" id="FIELD_SALE_COMPANY_ID">' . $strSelectCompany . '</select>
						</td>
					</tr>
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_SALE_COMPANY_CREATE") . ':</td>
						<td class="adm-detail-content-cell-r">
							<input type="checkbox" class="adm-bus-input" name="FIELDS[ACTION][SALE_COMPANY_CREATE]" value="Y" />
						</td>
					</tr>
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_SALE_COMPANY_RESTRICTION") . ':</td>
						<td class="adm-detail-content-cell-r">
							<input type="checkbox" class="adm-bus-input" name="FIELDS[ACTION][SALE_COMPANY_RESTRICTION]" value="Y" />
						</td>
					</tr>
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_SALE_COMPANY_GROUPS_CREATE") . ':</td>
						<td class="adm-detail-content-cell-r">
							<input type="checkbox" class="adm-bus-input" name="FIELDS[ACTION][SALE_COMPANY_GROUPS_CREATE]" value="Y" />
						</td>
					</tr>
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_SALE_COMPANY_GROUPS_LINK") . ':</td>
						<td class="adm-detail-content-cell-r">
							<input type="checkbox" class="adm-bus-input" name="FIELDS[ACTION][SALE_COMPANY_GROUPS_LINK]" value="Y" />
						</td>
					</tr>
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_DEFAULT_EMAIL") . ':</td>
						<td class="adm-detail-content-cell-r">
					...
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_PRICES") . ':</td>
						<td class="adm-detail-content-cell-r">
					...
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_STORES") . ':</td>
						<td class="adm-detail-content-cell-r">
					...
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_COUNTERS") . ':</td>
						<td class="adm-detail-content-cell-r">
					...
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_HEAD_STRING") . ':</td>
						<td class="adm-detail-content-cell-r">
					...
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_MAKE_SETTINGS_SITEMAP") . ':</td>
						<td class="adm-detail-content-cell-r">
							<input type="checkbox" class="adm-bus-input" name="FIELDS[ACTION][MAKE_SETTINGS_SITEMAP]" value="Y" />
						</td>
					</tr>
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_REGIONS_FIELD_MAKE_ROBOTS_FILE") . ':</td>
						<td class="adm-detail-content-cell-r">
