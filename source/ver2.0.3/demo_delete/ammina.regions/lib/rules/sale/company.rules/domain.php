...
namespace Ammina\Regions\Rules\Sale\CompanyRules;
...
class Domain extends Base\Restriction
{
	public static function onSaleCompanyRulesClassNamesBuildList()
	{
		return new \Bitrix\Main\EventResult(
			...
			array(
				'\Ammina\Regions\Rules\Sale\CompanyRules\Domain' => '/bitrix/modules/ammina.regions/lib/rules/sale/company.rules/domain.php',
			)
		);
	}
