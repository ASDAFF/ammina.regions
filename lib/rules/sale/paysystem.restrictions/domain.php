...
namespace Kit\MultiRegions\Rules\Sale\PaySystemRestrictions;
...
class Domain extends Base\Restriction
{
	public static function onSalePaySystemRestrictionsClassNamesBuildList()
	{
		return new \Bitrix\Main\EventResult(
			...
			array(
				'\Kit\MultiRegions\Rules\Sale\PaySystemRestrictions\Domain' => '/bitrix/modules/kit.multiregions/lib/rules/sale/paysystem.restrictions/domain.php',
			)
		);
	}
